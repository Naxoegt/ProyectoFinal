...
class PanelBus extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        //Agregar Informacion de precios
        Image i = new ImageIcon(this.getClass().getResource("../Grafico/AsientoNormalDisponible.png")).getImage();
        g.drawImage(i, 100, 50, 70, 70, this);

        Image e = new ImageIcon(this.getClass().getResource("../Grafico/AsientoPremiumDisponible.png")).getImage();
        g.drawImage(e, 170, 50, 70, 70, this);
